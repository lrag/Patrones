...
import com.curso.modelo.proxy.ServicioClientesProxy;
import com.curso.modelo.proxy.ServicioProductosProxy;
...
public class GestorPedidos {
	...
	@Autowired private ServicioClientesProxy servicioClientesProxy;
	@Autowired private ServicioProductosProxy servicioProductosProxy;
	...
	public Pedido altaPedido(Pedido pedido) {
		...
		Cliente cliente = servicioClientesProxy.buscar(login);
		...
		for(DetallePedido dp : pedido.getDetalles()) {
			...
			Producto producto = servicioProductosProxy.buscar(codigoProducto);
