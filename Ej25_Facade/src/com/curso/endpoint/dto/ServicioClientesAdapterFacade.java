...
public class ServicioClientesAdapterFacade {

	private ServicioClientes servicioClientes;
	private RepositorioClientes repositorioClientes;
	
	public ServicioClientesAdapterFacade(ServicioClientes servicioClientes, RepositorioClientes repositorioClientes) {
		super();
	...
	public ClienteDTO buscar(Long idCliente) {
		return getClienteDTOFrom(repositorioClientes.buscar(idCliente));
	}
	
	public List<ClienteDTO> listar() {
		return repositorioClientes.listar().stream()
	...
	private Cliente getClienteFrom(ClienteDTO clienteDTO) {
		...
		Cliente cAux = repositorioClientes.buscar(clienteDTO.getId());
