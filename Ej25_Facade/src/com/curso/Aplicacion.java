...
import com.curso.persistencia.RepositorioClientesArrayListImplementation;

public class Aplicacion {

	public static void main(String[] args) {

		RepositorioClientes repositorioClientes = new RepositorioClientesArrayListImplementation();
		ServicioClientes servicioClientes = new ServicioClientesImplementation(repositorioClientes);
		ServicioClientesAdapterFacade servicioClientesAdapter = new ServicioClientesAdapterFacade(servicioClientes, repositorioClientes);
