...
public class CalificacionProductosRest {
	...
	/*
	//Otra opción
	@GetMapping(path="/producto/{codigoProducto}/calificaciones_productos")
	...
	*/	
	...
	public List<CalificacionProducto> listarPorProducto(@RequestParam("codigoProducto") String codigoProducto){
